...
public class DateChooser extends JPanel{  
   ...
   private JP2 jp2;  
    ...
    public DateChooser(Date date, String format, PreviousDataWindow pdwnd){  
    	pdWnd = pdwnd;
        initDate=date;  
...
//      this.add(toSelect,BorderLayout.EAST);  
    ...
    private void commit(){  
        ...
        if(pdWnd != null){
        	...
        	HGclienthttp.constructDaysGaemDetailsForRatioAns();
        }else if(bindName.equals("pankouansdates")){
        	StoneAge.pankouansWnd.updateEventsDetails();
        }else if(bindName.equals("pankouansdatee")){
        	StoneAge.pankouansWnd.updateEventsDetails();
        }
